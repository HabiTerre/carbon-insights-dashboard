...
const DashboardHeader = () => {
  return <Card className="border-brand-grey shadow-lg hover:shadow-xl hover:bg-brand-grey/20 hover:border-brand-primary transition-all duration-300 rounded-lg border-b">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 text-right">
              <img src="/lovable-uploads/371e665e-76d1-439d-9997-0583d836e94c.png" alt="HabiTerre Logo" className="h-12 w-12 object-cover object-left-bottom rounded-lg" />
              <div>
